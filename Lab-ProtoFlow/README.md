...
	нажать клавишу ввода ENT 6 (Рис. 3);
	после окончания этапа предварительного нагрева выдвигается моторизированный выдвижной ящик (Рис. 2);
	поместить ПП с компонентами  наалюминиевые накладки  (Рис. 2);
	при необходимости присоединить термопары на плату;
	нажать клавишу ENT для закрытия выдвижного ящика и начала этапа оплавления;
	на дисплее можно наблюдать распределение температуры в разных частях рабочей зоны и продолжительность процесса;
	после окончания процесса пайки ящик автоматически выдвигается;
	ВАЖНО: не брать плату сразу после открытия, плата должна остыть;
	вынуть  печатную плату;
	нажать клавишу ENT для закрытия выдвижного ящика;
	выключить печь.
